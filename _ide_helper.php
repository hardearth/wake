...
')
     ...
     */ 
         ...
         *
         * @param \Hexters\CoinPayment\Helpers\[type] $array
         * @return void 
         * @static 
         */ 
        public static function generatelink($array)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->generatelink($array);
        }
                    /**
         * Get raw transaction
         *
         * @param \Hexters\CoinPayment\Helpers\[type] $string
         * @return void 
         * @static 
         */ 
        public static function getrawtransaction($string)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->getrawtransaction($string);
        }
                    /**
         * Get status by txn ID
         *
         * @param \Hexters\CoinPayment\Helpers\[type] $txn_id
         * @return void 
         * @static 
         */ 
        public static function getstatusbytxnid($txn_id)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->getstatusbytxnid($txn_id);
        }
                    /**
         * Get balances
         *
         ...
         *
         * @param \Hexters\CoinPayment\Helpers\[type] $currency
         * @return void 
         * @static 
         */ 
        public static function getDepositAddress($currency)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->getDepositAddress($currency);
        }
                    /**
         ...
         * @static 
         */ 
        public static function createWithdrawal($body)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->createWithdrawal($body);
        }
                    /**
         * get withdrawal info
         *
         ...
         * @static 
         */ 
        public static function getWithdrawalInfo($id)
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        $instance->getWithdrawalInfo($id);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function api_call($cmd, $req = [])
        {
                        /** @var \Hexters\CoinPayment\Helpers\CoinPaymentHelper $instance */
                        return $instance->api_call($cmd, $req);
        }
...
namespace  { 
            ...
            class CoinPayment extends \Hexters\CoinPayment\CoinPayment {}
