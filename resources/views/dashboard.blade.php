                                ...
                                <div class="row align-items-end">
                                    <div class="col-sm-8">
                                        <div class="p-3">
                                            ...
                                            <div class="mt-3">
                                                <router-link to="/pages/pricing" class="btn btn-success">Upgrade Account!
                                                </router-link>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="px-3">
                                            <img src="{{asset('/assets/velzon/images/user-illustarator-2.png')}}" class="img-fluid" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end card-body-->
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="text-center">
                                        <img src="{{asset('/assets/velzon/images/illustrator-1.png')}}" class="img-fluid" alt="">
                                    </div>
                                </div><!-- end col -->
                            </div><!-- end row -->
                            <div class="mt-3 pt-2">
